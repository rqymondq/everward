...
function BookingLink({ className = "button", label = "Book a call" }: { className?: string; label?: string }) {
  return <a className={className} href={BOOKING_URL}>{label}<span aria-hidden="true">↗</span></a>;
}
  ...
  return (
    <main>
      <header className="site-header">
        <a className="wordmark" href="#top" aria-label="Everward home"><span className="wordmark-mark">E</span><span>Everward</span></a>
      ...
      <section className="handles-section" id="handles">
        <div className="section-shell">
          ...
          <div className="responsibility-grid">
            <article className="everward-list"><div className="list-title"><span className="wordmark-mark">E</span><h3>Everward handles</h3></div><ul>{everwardHandles.map((item) => <li key={item}><span>+</span>{item}</li>)}</ul></article>
      ...
      <footer className="site-footer"><div className="section-shell footer-grid"><div><a className="wordmark footer-wordmark" href="#top"><span className="wordmark-mark">E</span><span>Everward</span></a><p>British Columbia, Canada</p></div><div className="footer-contact"><span>Direct contact</span><a href="mailto:hello@everward.ca">hello@everward.ca</a></div><div className="footer-meta"><span>© 2026 Everward</span><span aria-label="Legal pages forthcoming">Privacy · Terms</span></div></div></footer>
    </main>
  );
}
